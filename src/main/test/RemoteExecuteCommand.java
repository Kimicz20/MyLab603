...
public class RemoteExecuteCommand {
    ...
    public static void main(String[] args) {
        RemoteExecuteCommand rec = new RemoteExecuteCommand("192.168.0.131", "root","1");
        //执行命令
        System.out.println(rec.execute("sh /home/8_11_Finall/start.sh"));
        //执行脚本
//        rec.execute("sh /home/8_11_Finall/Test/start.sh");
        //这个方法与上面最大的区别就是，上面的方法，不管执行成功与否都返回，
        //这个方法呢，如果命令或者脚本执行错误将返回空字符串
//        rec.executeSuccess("sh /home/8_11_Finall/Test/start.sh");
